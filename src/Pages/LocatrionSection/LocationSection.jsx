        ...
        <div className="px-4 py-12 max-w-7xl mx-auto sticky top-0">
            ...
            <div className="flex items-center max-w-md mx-auto mb-6 shadow-md rounded-full overflow-hidden">
                ...
                <button
                    ...
                    style={{
                        background: 'linear-gradient(to right, #f40752, #f9ab8f)'
                    }}
                >
                    <FaSearch size={18} />
                </button>
                        ...
                        >
                            <Popup>
                                <div className="space-y-1">
                                    <p className="font-semibold text-base">{branch.city} - {branch.district}</p>
                                    <p className="text-sm text-gray-700">{branch.region}</p>
                                    ...
                                    <p className="text-sm text-gray-700">Covered Areas: {branch.covered_area.join(', ')}</p>
                                    {branch.flowchart && (
                                        <a
