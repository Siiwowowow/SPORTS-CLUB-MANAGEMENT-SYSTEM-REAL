  ...
  return (
    <div className="px-4 py-10">
      <div className="flex flex-wrap items-center justify-center gap-6">
        {/* Review Card 1 */}
        <div className="text-sm w-80 border border-gray-500/30 pb-6 rounded-lg bg-white shadow-md overflow-hidden">
        ...
        <div className="text-sm w-80 border border-gray-500/30 pb-6 rounded-lg bg-white shadow-md overflow-hidden">
          ...
          <div className="p-5 pb-7">
            ...
            <p className="text-gray-500 mt-5">
              Imagify has significantly improved my workflow, allowing me to manage and edit content with ease.
            </p>
          </div>
          <a href="#" className="text-red-500 underline px-5">
            Read more
        ...
        <div className="text-sm w-80 border border-gray-500/30 pb-6 rounded-lg bg-white shadow-md overflow-hidden">
          ...
          <div className="p-5 pb-7">
            ...
            <p className="text-gray-500 mt-5">
              Excellent service with user-friendly features that have transformed my content creation process.
            </p>
          </div>
          <a href="#" className="text-red-500 underline px-5">
            Read more
